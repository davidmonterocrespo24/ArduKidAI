...
// Parts stack in a single tall column on the left (matching the backend
// auto-layout) so they never overlap each other or the pinned board.
const SPAWN_GRID_X = 200
const SPAWN_GRID_Y = 130
