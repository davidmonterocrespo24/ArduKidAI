---
name: smallSoundSensor
description: Use whenever the circuit reacts to sound or noise with the small sound sensor board. Covers the exact wire() pin names (AOUT, GND, VCC, DOUT), which pins are analog vs digital, and how to read loudness or a loud-noise threshold.
---

# Sound sensor (small board)

A compact microphone module that reports loudness on an analog output and a loud-noise threshold on a digital output.
