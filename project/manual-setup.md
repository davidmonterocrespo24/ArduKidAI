...
| # | Task | URL | Deadline | Output Claude needs | Status |
| --- | --- | --- | --- | --- | --- |
| M9 | Create an Artifact Registry repository for Docker images | GCP console | Phase 5 | repository name | [ ] |
| M10 | Configure Cloud Build trigger on push to `main` | GCP console | Phase 5 | trigger ID | [ ] |
| M11 | (Optional) Verify a custom domain for Firebase Hosting / Cloud Run | Hosting console | Phase 5 | domain | [ ] |
| M12 | Confirm Gemini safety settings on the Agent Builder agent | Agent Builder console | Phase 5 | - | [ ] |
